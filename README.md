...
[Watch the Walkthrough](https://drive.google.com/file/d/1FsjGzNQvNnU0e2JcCH4U0-GzCnEc7y5u/view?usp=sharing)
...
1. **Clone and Install**
```bash
git clone https://github.com/rajatsah95/vsAssignment.git
cd frontend
cp .env.example .env
npm install
```
